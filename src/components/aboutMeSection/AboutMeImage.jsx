...
import foto from '/faniesa dokumen/about.png';

const AboutMeImage = () => {
  return (
    <div className='h-[500px] w-[300px] relative'>
        <div className='h-[500px] w-[500px] rounded-[100px] absolute overflow-hidden'>
            <img src={`${import.meta.env.BASE_URL}faniesa dokumen/about.png`} alt="About Me" className='h-full w-auto object-cover'/>
        </div>
